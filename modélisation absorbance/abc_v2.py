...
def prepare_radis_cache(regen_cache: bool = False) -> None:
    ...
    # =========================================================
    # BLOC AJOUTÉ : Force le téléchargement/vérification de HITRAN
    # =========================================================
    from radis import fetch_databank
    try:
        fetch_databank('hitran', 'CO2')
        print("Base de données HITRAN pour le CO2 récupérée avec succès.")
    except Exception as e:
        print(f"Erreur lors du téléchargement de la base de données HITRAN : {e}")
    # =========================================================
