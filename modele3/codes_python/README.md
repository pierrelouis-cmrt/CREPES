...
Le script peut aussi être lancé directement :

```bash
python modele3/codes_python/modele3.py --lat 48.5 --lon 2.3 --mois 7 --temperature-surface 293 --moyenne-journaliere-sw
```
